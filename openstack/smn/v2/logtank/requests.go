...
func Update(client *golangsdk.ServiceClient, topicUrn string, logTankID string, ops Ops) (r CreateResult) {
	b, err := golangsdk.BuildRequestBody(ops, "")
	if err != nil {
		r.Err = err
		return
...
func Delete(client *golangsdk.ServiceClient, topicUrn string, LogTankID string) (r CreateResult) {
